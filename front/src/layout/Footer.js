        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-4 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Model Town Jalandhar, Punjab, India</p>
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>+919876543210</p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i>shubham@gmail.com</p>
            ...
            <div className="copyright">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a className="border-bottom" href="#">Autopoint</a>, All Right Reserved.
